...
public class Login extends JFrame {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == btn_login) {
                ...
                if (ReceiverFromUser.in) {
                    ...
                    //A bunch of detailed errors
                } else if (txt_username.getText().isEmpty()
                        || txt_username.getText().isBlank()
                        || !txt_username.isValid()
                        || txt_password.getText().isEmpty()
                        || txt_password.getText().isBlank()
                        || !txt_password.isValid()) {
                    JOptionPane.showMessageDialog(
                            null, "Invalid input for username and password",
                            "Error", JOptionPane.ERROR_MESSAGE);
                } else if (txt_username.getText().isEmpty() || txt_username.getText().isBlank() ||
                        !txt_username.isValid()) {
                    JOptionPane.showMessageDialog(
                            null, "Invalid input for username", "Error",
                            JOptionPane.ERROR_MESSAGE);
                } else if (txt_password.getText().isEmpty() || txt_password.getText().isBlank() ||
                        !txt_password.isValid()) {
                    JOptionPane.showMessageDialog(
                            null, "Invalid input for password", "Error",
                            JOptionPane.ERROR_MESSAGE);
    ...
    public Login() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    null, "Server not started, please start the server for the program to" +
                            " function properly", "Error", JOptionPane.ERROR_MESSAGE);
            e1.printStackTrace();
        }
